Public Class launcherNew
    ...
    Private Sub appList_lst_SelectedIndexChanged(sender As Object, e As EventArgs) Handles appList_lst.SelectedIndexChanged
        If appList_lst.SelectedIndex = 0 Then
        ...
        ElseIf appList_lst.SelectedIndex = 1 Then
        ...
        ElseIf appList_lst.SelectedIndex = 2 Then
        ...
        ElseIf appList_lst.SelectedIndex = 3 Then
        ...
        ElseIf appList_lst.SelectedIndex = 4 Then
